        ...
        <div class="container">
                ...
                <div class="col-12 table-responsive">
                    <table class="table table-borderless table-cart">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 20%;">
                                    @if (isset($cart->product->galleries->first()->photo))
                            ...
                            <tr>
                                <td colspan="4">
                                    <p class="text-danger text-center text-muted small">Anda Belum Menambahkan
                                        Produk
                                        Apapun!
                                        Happy Shopping!</p>
                                </td>
            ...
            <form action="{{ route('checkout') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="provinces_id"
                                    id="provinces_id"
                                    class="mySelectProvinces form-select"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="regencies_id"
                                    id="regencies_id"
                                    class="form-select mySelectCity"
                ...
                <div class="row"
                    ...
                    <div class="col-2">
                        <div class="product-title">IDR. 0</div>
                        <div class="product-subtitle">Ship to Blitar</div>
                    </div>
                    <div class="col-4">
